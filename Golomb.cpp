    ...
    public:
      ...
      int decoder(int m, string sin){
        ...
        for(int i=sz-1; i>=0; i--) {
          ...
          if (sin[sz -1 -i] == '0' && i == sz -1) 
            break;
          
          if (sin[sz -1 -i] == '1' && i == sz -1) 
            s+=1;
          else if(sin[sz -1 -i]=='1' && sin[sz -1 -i -1] =='1') 
            s+=1;
          else if(sin[sz -1 -i] =='0' && s!=0) 
            break;
          else if(sin[sz -1 -i] =='1' && sin[sz -1 -i -1] == '0') 
            s+=1;
        }
        ...
        for (int i = x1.length()-1 ; i>=0 ; i--) 
          if(x1[i] == '1') x += pow(2,x1.length()-1-i);
